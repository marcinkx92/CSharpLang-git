...
using System.Text;
    ...
    public class Parameters
    {
        ...
        public static void Test()
        {
            ...
            Console.WriteLine("Test 1: przekazywanie parametrów przez wartość (tryb domyślny)");
            int liczba1 = 1;
            ...
            Console.WriteLine("Test 2: przekazywanie parametrów przez referencje");            
            int liczba2 = 1;
            ...
            Console.WriteLine("Test 3: Pzekazywanie wielu argumentów: PARAMS"); 
            MethodParams(1); //1
            ...
            Console.WriteLine("Test 4: Parametry opcjonalne");
            OptionalParameters(1,2,3); //a=1,b=2,c=3
            OptionalParameters(10,100); //a=10, b=100, c=10 (wartość domyślna)
            
            Console.WriteLine("Test 4: Parametry opcjonalne + nazwane"); 
